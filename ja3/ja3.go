...
// OrigString returns the original JA3 SSL Client Fingerprint string.
func OrigString(hello *tlsx.ClientHelloBasic) string {
	return string(Bare(hello))
}

func GetSNI(hello *tlsx.ClientHelloBasic) string {
	return hello.SNI
}
